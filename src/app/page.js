...
export default function LandingPage() {
  ...
  // Handler to order from product modal
              ...
              {wishlistLoading ? (
                ...
                <div className="space-y-4">
                  {wishlistProducts.map(product => (
                    <div key={product.id} className="flex items-center gap-4 bg-gray-50 rounded-xl p-4 shadow cursor-pointer" onClick={() => handleProductClick(product)}>
                      <Image
                      ...
                      <button
                        className="text-green-600 hover:underline font-semibold px-4 py-2 rounded-full border border-green-600 hover:bg-green-50 transition"
                        onClick={e => { e.stopPropagation(); openOrderModal(product); setShowWishlist(false); }}
                      >
                        Order
                      </button>
                    </div>
              ...
              <div className="overflow-hidden rounded-2xl shadow-xl">
                ...
                >
                  {newArrivals.map((product, idx) => (
                    <div key={product.id} className="min-w-full flex flex-col md:flex-row bg-white cursor-pointer" style={{ minHeight: '420px' }} onClick={() => handleProductClick(product)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex flex-col items-center gap-4">
                <a
                  href="https://www.instagram.com/shop_just_put_on?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold shadow-lg hover:from-pink-600 hover:to-purple-700 transition text-lg"
                >
                  <svg width="24" height="24" fill="currentColor" className="inline-block"><path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm4.25 3.25a5.25 5.25 0 1 1 0 10.5 5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5zm5.25.75a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>
                  Follow us on Instagram
                </a>
                <div className="flex gap-6">
                  <span className="inline-flex items-center gap-2 text-lg font-semibold text-gray-800 bg-white rounded-full px-4 py-2 shadow">
                    <svg width="20" height="20" fill="currentColor" className="inline-block text-green-600"><path d="M2.003 5.884l2-3.5A2 2 0 0 1 5.66 1h2.68a2 2 0 0 1 1.657.884l2 3.5A2 2 0 0 1 12.34 7H7.66a2 2 0 0 1-1.657-.884l-2-3.5zM2 8.5A1.5 1.5 0 0 1 3.5 7h13A1.5 1.5 0 0 1 18 8.5v7A1.5 1.5 0 0 1 16.5 17h-13A1.5 1.5 0 0 1 2 15.5v-7z"/></svg>
                    0562506372
                  </span>
                  <span className="inline-flex items-center gap-2 text-lg font-semibold text-gray-800 bg-white rounded-full px-4 py-2 shadow">
                    <svg width="20" height="20" fill="currentColor" className="inline-block text-green-600"><path d="M2.003 5.884l2-3.5A2 2 0 0 1 5.66 1h2.68a2 2 0 0 1 1.657.884l2 3.5A2 2 0 0 1 12.34 7H7.66a2 2 0 0 1-1.657-.884l-2-3.5zM2 8.5A1.5 1.5 0 0 1 3.5 7h13A1.5 1.5 0 0 1 18 8.5v7A1.5 1.5 0 0 1 16.5 17h-13A1.5 1.5 0 0 1 2 15.5v-7z"/></svg>
